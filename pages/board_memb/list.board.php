...
?>
<title>
    Board_Memb List | SFAC - Las Piñas
</title>
</head>
...
<body class="g-sidenav-show  bg-gray-100">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 mt-1 border-radius-lg ">
        ...
        <h6 class="font-weight-bolder mb-0">View Board_Memb List</h6>
                ...
                <div class="col-12">
                    <div class="card shadow shadow-xl">
                        ...
                        <div class="card-header">
                            <h5 class="mb-0">Board_Memb List</h5>
                        ...
                        <div class="table-responsive px-4 my-4">
                            <table class="table table-flush table-hover responsive nowrap" style="width: 100%;"
                                ...
                                <tbody>
                                    <?php
                                    $listBoardMember = mysqli_query($db, "SELECT *, CONCAT(tbl_board_memb.board_memb_lastname, ', ', tbl_board_memb.board_memb_firstname, ' ', tbl_board_memb.board_memb_middlename) AS fullname FROM tbl_board_memb");
                                    while ($row = mysqli_fetch_array($listBoardMember)) {
                                        $id = $row['board_memb_id'];
                                    ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-sm font-weight-normal">
                                            <?php echo $row['board_memb_lastname']; ?></td>
                                        <td class="text-sm font-weight-normal">
                                            <?php echo $row['board_memb_firstname']; ?></td>
                                        <td class="text-sm font-weight-normal">
                                            <?php echo $row['board_memb_middlename']; ?></td>
                                        ...
                                        <td class="text-sm font-weight-normal">
                                            <a class="btn bg-gradient-primary text-xs"
                                                href="edit.board_memb.php?board_memb_id=<?php echo $id; ?>"><i
                                        ...
                                        <div class="modal-dialog modal-danger modal-dialog-centered modal-"
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <a href="userData/ctrl.del.board_memb.php?board_memb_id=<?php echo $id; ?>"
