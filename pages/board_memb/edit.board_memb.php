...
if ($_SESSION['role'] == "Super Administrator") {
    $board_memb_id = $_GET['board_memb_id'];
}

$_SESSION['board_memb_id'] = $board_memb_id;
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 mt-1 border-radius-lg ">
        ...
        <div class="container-fluid py-4">
            <div class="col-lg-11 mt-lg-0 mt-4 mx-auto">
                    ...
                    <div class="row justify-content-center align-items-center">
                        <div class="col-sm-auto col-4">
                            <div class="avatar avatar-xl position-relative">
                                <?php
                                $getUserData = mysqli_query($db, "SELECT *, CONCAT(tbl_board_memb.board_memb_firstname, ' ', tbl_board_memb.board_memb_middlename, ' ', tbl_board_memb.board_memb_lastname) AS fullname FROM tbl_board_memb WHERE board_memb_id = '$board_memb_id'");
                        ...
                        <form method="POST" enctype="multipart/form-data" action="userData/ctrl.edit.board_memb.php"
                ...
                <!-- Card Basic Info -->
                <form method="POST" enctype="multipart/form-data" action="userData/ctrl.edit.board_memb.php" class="card mt-4"
                    id="basic-info">
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="input-group">
                                    <input id="lastName" name="lname" class="form-control" type="text"
                                        ...
                                        value="<?php echo $row['board_memb_lastname'];
                                                                                                                                        ?>">
                                </div>
                            </div>
                            <div class="col-sm-4">
                                ...
                                <div class="input-group">
                                    <input id="firstName" name="fname" class="form-control" type="text"
                                        ...
                                        value="<?php echo $row['board_memb_firstname'];
                                                                                                                                        ?>">
                                </div>
                            </div>
                            <div class="col-sm-4">
                                ...
                                <div class="input-group">
                                    <input id="middlename" name="mname" class="form-control" type="text"
                                        placeholder="Middlename" value="<?php echo $row['board_memb_middlename']; ?>">
                                </div>
                            </div>
                ...
                <form class="card mt-4 mb-5" id="password" method="POST" action="userData/ctrl.edit.board_memb.php">
                    <div class="card-header">
